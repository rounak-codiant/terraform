...
| <a name="input_project_name"></a> [project\_name](#input\_project\_name) | To define project name | `any` | n/a | yes |
...
| <a name="input_vpc_cidr_block"></a> [vpc\_cidr\_block](#input\_vpc\_cidr\_block) | To define vpc CIDR block | `any` | n/a | yes |

## Outputs

| Name | Description |
|------|-------------|
| <a name="output_available_zones"></a> [available\_zones](#output\_available\_zones) | To get available zones |
| <a name="output_ec2_public_subnet"></a> [ec2\_public\_subnet](#output\_ec2\_public\_subnet) | To get only one public subnet |
| <a name="output_private_subnet"></a> [private\_subnet](#output\_private\_subnet) | To get private subnets |
| <a name="output_public_subnet"></a> [public\_subnet](#output\_public\_subnet) | To get public subnets |
| <a name="output_vpc_id"></a> [vpc\_id](#output\_vpc\_id) | To get VPC id |
